namespace WkeSampleLoadApp.Tools
{
    ...
    public class WkeAuthenticationTools
    {

        public async Task<WkeProcessAuthorizationCodeResult> ProcessAuthorizationCodeAsync(
            AuthorizationCodeReceivedContext context, string baseUrl, string clientId, string clientSecret)
        {
            ...
            return new WkeProcessAuthorizationCodeResult()
            {
                Claims = claims,
